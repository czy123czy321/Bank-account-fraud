...
echo "Converting feature engineering preprocessing notebook to Python script..."
if jupyter nbconvert --to script $CODE_DIR/feature_engineering/preprocessing_notebook.ipynb --output $CODE_DIR/feature_engineering/preprocessing >>"$LOG_FILE" 2>&1; then
    log "feature engineering preprocessing notebook converted to script in $CODE_DIR/feature_engineering."
else
