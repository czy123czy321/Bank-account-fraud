...
LOG_FILE="$CODE_DIR/feature_engineering/feature_engineering_workflow_250210.log"
...
if jupyter nbconvert --to script $CODE_DIR/feature_engineering/feature_engineering.ipynb --output $CODE_DIR/feature_engineering/feature_engineering >>"$LOG_FILE" 2>&1; then
...
if $PYTHON_EXEC "$CODE_DIR/feature_engineering/feature_engineering.py" >>"$LOG_FILE" 2>&1; then
